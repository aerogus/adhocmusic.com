...
class Membre extends Contact
{
     ...
     * @var string
     */
    protected static $pk = 'id_contact';

    /**
     * @var string
     */
    protected static $table = 'adhoc_membre';
     ...
     * @var string
     */
    protected $id_departement = null;

    /**
     * @var string
     */
    protected $id_region = null;
