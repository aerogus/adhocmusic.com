...
{include file="fb/adhocmusic/tab/common/boxstart.tpl" title="A Propos"}

<img src="http://static.adhocmusic.com/img/logo_adhoc.png" align="right" />

<p><strong>AD'HOC</strong> est une association à but non lucratif, originaire d'Epinay-sur-Orge (91 - Essonne) oeuvrant pour le développement de la scène musicale actuelle depuis près de 15 ans (création en 1996).</p>
...
<p>L'association <strong>AD'HOC</strong> c'est une équipe d'une dizaine de personnes actives pour l'organisation des concerts, c'est plus 2000 membres internet, près de 3500 inscrits à la newsletter et près de 400 groupes référencés de toute la France.</p>

<p>Cette application fait le pont entre l'univers Facebook et le site AD'HOC. Venez tester le quiz en cliquant sur le menu !</p>
