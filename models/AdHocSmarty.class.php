...
class AdHocSmarty extends Smarty
{
    ...
    public function __construct()
    {
        ...
        if(defined('DEBUG_MODE_BY_IP')) {
            $this->config_vars['DEBUG_MODE_BY_IP'] = DEBUG_MODE_BY_IP;
        }

        if(defined('SHOW_MOBILE_LINK')) {
            $this->assign('show_mobile_link', true);
        }
...
*/
    ...
    public function fetch($template = null, $cache_id = null, $compile_id = null, $parent = null, $display = false, $merge_tpl_vars = true, $no_output_filter = false)
    {
        ...
        /* debug mode */
        if(DEBUG_MODE_BY_IP && false) {
            $this->assign('debug_mode', true);
            $this->assign('sql_log', DataBase::getInstance()->getDebugLog());
            $this->assign('memory_peak', memory_get_peak_usage());
        }
