...
define('ADHOC_ROUTES_FILE',         ADHOC_ROOT_PATH . '/config/routes');
define('ADHOC_SITE_PATH',           ADHOC_ROOT_PATH . '/models');
define('ADHOC_LOG_PATH',            ADHOC_ROOT_PATH . '/log');
define('DEFAULT_CONTROLLERS_PATH',  ADHOC_ROOT_PATH . '/controllers/');
...
define('SMARTY_TEMPLATE_PATH',   ADHOC_ROOT_PATH . '/views');
