...
(function($){
	$.fn.galleryView = function(options) {
		...
		var theme_path = '../img/galleryview';			// STRING - relative path to theme directory
		...
		return this.each(function() {
			...
			$('script').each(function(i){
				...
				if(s.attr('src') && s.attr('src').match(/jquery\.galleryview/)){
					loader_path = s.attr('src').split('jquery.galleryview')[0]+'../img/galleryview/';
					theme_path = s.attr('src').split('jquery.galleryview')[0]+'../img/galleryview/';	
				}
			});
...
*/
	$.fn.galleryView.defaults = {
		...
		nav_theme: '',	    				//STRING - name of navigation theme to use (folder must exist within 'themes' directory)
