...
/* assoce/equipe.twig */
class __TwigTemplate_b0809f087066061656965262fa81c4f9 extends Template
{
    ...
    <div class=\"box\">
      ...
      <div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["membre"]) {
            ...
            <img src=\"";
            // line 12
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "avatar_interne", [], "any", false, false, false, 12), "html", null, true);
            yield "\" alt=\"\">
            <strong>";
            // line 13
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "firstName", [], "any", false, false, false, 13), "html", null, true);
            yield " ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "lastName", [], "any", false, false, false, 13), "html", null, true);
            yield "</strong><br>
            <em>";
            // line 14
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["membre"], "function", [], "any", false, false, false, 14), "html", null, true);
            yield "</em>
          </li>
          ";
        }
...
";
        // line 74
        yield from         $this->loadTemplate("common/footer.twig", "assoce/equipe.twig", 74)->unwrap()->yield($context);
        yield from [];
    }
    ...
    {
        return array (  139 => 74,  80 => 17,  71 => 14,  65 => 13,  61 => 12,  58 => 11,  54 => 10,  44 => 2,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "assoce/equipe.twig", "/var/www/docker.adhocmusic.com/app/twig/assoce/equipe.twig");
    }
}
