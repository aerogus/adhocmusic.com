...
{include file="common/boxstart.tpl" boxtitle="Ajouter un message"}
...
<form id="form-forum-write" name="form-forum-write" method="post" action="/forums/write">
  <ol>
    ...
    <li>
      ...
      <textarea class="tinymce" style="width: 100%;" name="text" id="text" rows="10" cols="80">{$text|escape}</textarea>
    </li>
    <li>
